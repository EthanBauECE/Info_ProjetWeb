...
<body>
  ...
  <main style="padding: 2rem; background-color: #f9f9f9;">
    ...
    <section id="alice-dupont" class="info-card" style="background-color: #ffffff;">
      ...
      <img src="alice_dupont.jpg" alt="Dr. Alice Dupont" style="width: 200px; border-radius: 8px; margin: 1rem 0;" />
      ...
      <h3>CV :</h3>
      <p>Diplômée de l’Université de Paris Descartes. 10 ans d'expérience en médecine générale. Spécialisée en suivi de patients chroniques et prévention.</p>
